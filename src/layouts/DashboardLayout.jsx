    ...
    <div className="flex h-screen">
      <div className='bg-gray-50 w-1/6 flex flex-col p-4 border-r border-gray-300'>
        ...
        <nav className='space-y-4 pb-10'>
          ...
          <div className='text-epaColor1 font-medium'>
            <Link className='flex gap-2 items-center transition-transform duration-300 hover:translate-x-4' to={ '' }>
        ...
        <GlobalButton variant='danger' onClick={logout} className='p-1' >Cerrar Sesión</GlobalButton>
      </div>
